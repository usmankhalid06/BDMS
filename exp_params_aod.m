...
out_path = 'D:\Matlab\workorg\python\SimTB';
...
nV = 70; % number of voxels; dataset will have [nV x nV] voxels.           
...
% SM_source_ID = [30 6 2 20 9 23 11 29];% 21
SM_source_ID = [3 8 10 21 22 23 26 25]; %21 30
%  SM_source_ID = [ 5 ,6 , 16]; %partial overlap
%  SM_source_ID = [ 2 ,7 , 17]; %complete overlap
%  SM_source_ID = [ 2 ,18 , 17]; %complete overlap
% SM_source_ID = [5, 6 ,2 , 4, 3, 9];  %No overlap
nC = length(SM_source_ID);  % number of components        


% 3    10     4    22     6     5    23    26    12    29  8    30
